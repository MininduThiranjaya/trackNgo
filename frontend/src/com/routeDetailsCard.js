...
export default function RouteDetailsCard({busRouteWithBus}) {
  ...
  //                 <Card.Text>
  //                   <p>
  //                     <b>Starts : </b>{e.startLocation}
  //                   </p>
  //                   <b>Stops : </b> 
  //                   <ul>
  //                       {
  //                         e.routeStops.map((stop, index) => {
  //                           return (
                ...
                <Card className="px-4" style={{ backgroundColor: '#f8f9fa' }}>
                  ...
                  <Card.Text>
                    ...
                    <Container>
                      <Row className='g-2'>
                          <hr></hr>
                          <Col xs={12} md={2}>{e.busNumber}</Col>
                          <Col xs={12} md={3}>Location</Col>
                          <Col xs={12} md={4}>
                          {
                            (e.status ?
                            ...
                            <Col xs={12} md={3}>
                            <NavLink to={`/client-bus-route-map/${e._id}/${e.busNumber}`} activeClassName="active">
                              <FontAwesomeIcon icon={faLocationCrosshairs} size="lg"  className='px-1' style={{color: "#3512e2"}} />
                              Find Me
                            </NavLink>
                          </Col>
